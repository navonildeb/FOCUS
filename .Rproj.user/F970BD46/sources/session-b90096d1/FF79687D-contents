...
W_full <- read_csv("HeartSteps_Experiments/HeartStepsV1-main/data_files/cleaned_data/W_full.csv")
W_full <- W_full[, -1] + 0

Y_full <- read_csv("HeartSteps_Experiments/HeartStepsV1-main/data_files/cleaned_data/log_jb30_full.csv")
Y_full <- Y_full[, -1]
...
save(hs_out, file = "HeartSteps_Experiments/HeartStepsV1-main/data_files/hs_out.RData")
