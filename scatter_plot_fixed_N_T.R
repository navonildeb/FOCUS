...
if (dgp_ind == 0 && h == 1) plt1 <- scatter_plt
if (dgp_ind == 0 && h == 2) plt2 <- scatter_plt

plt_name <- sprintf("figures_out/scatter_plots/scatter_plot_DGP%d_T%d_h%d.pdf", dgp_ind, TT_arr[t_ind], h)
